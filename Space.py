...
mongo_proximity1_username="tushar"
mongo_proximity1_password="tushar422"
...
mongo_proximity2_db="proximity_distance_filter"
url2="mongodb://{}:{}@{}:{}/?authSource={}"
url2=url.format(mongo_proximity1_username,mongo_proximity1_password,mongo_host,mongo_port,mongo_proximity_db)
mongo_client2=mc(url2,appname="wt_mongo_client",connect=False,maxPoolSize=500)
